			    ...
			    <div className="am-form">
				    ...
				    <div className="am-g am-margin-top">
				        ...
				        <div className="am-u-sm-8 am-u-md-10">
				            你参与<input type="text" id="subject" className="am-input-sm settings_input" />，成功获得<input type="text" id="send_name" className="am-input-sm settings_input" />赠送的红包，<input type="text" id="description" className="am-input-sm settings_input" />
				        </div>
				    ...
				    <div className="am-g am-margin-top">
				        ...
				        <div className="am-u-sm-8 am-u-md-4">
				        	<input type="text" id="body" className="am-input-sm settings_input" />
				        </div>
				        <div className="am-hide-sm-only am-u-md-6">*必填</div>
				    </div>
