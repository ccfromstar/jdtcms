				    ...
				    React.createElement("div", {className: "am-g am-margin-top"}, 
				  	...
				  	React.createElement("div", {className: "am-panel am-panel-default admin-sidebar-panel"}, 
				        React.createElement("div", {className: "am-panel-bd"}, 
				          ...
				          "基础权限：可登录管理系统，修改自身帐号密码，仅可查询自己所辖关注者基本信息及行为记录或激活建定通帐号。" + ' ' +
"管理权限：可查询所有关注者基本信息及行为记录，为关注者分配客服。" + ' ' +
"派发权限：可派发新手红包，批准关注者积分兑换红包请求。" + ' ' +
"自定义派发权限：可自定义增减关注者积分、建定通使用天数、红包金额。" + ' ' +
"系统权限：可进入“系统参数”页面定义系统各关键参数，管理所有管理帐号（添加帐号、停权帐号、修改密码、增删权限），也可进入“服务号管理”页面发送服务号软文，向关注者群发信息。"
				          )
				        )
				    )
				), 
