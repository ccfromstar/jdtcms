			...
			React.createElement("div", {className: "admin-content"}, 
				...
				React.createElement("div", {className: "am-form"}, 
				    ...
				    React.createElement("div", {className: "am-g am-margin-top"}, 
				        ...
				        React.createElement("div", {id: "score_focus_div", className: "am-u-sm-8 am-u-md-4"}, 
				            "0"
				        ), 
				        React.createElement("div", {className: "am-hide-sm-only am-u-md-6"}, 
				        	...
				        	React.createElement("button", {onClick: o.readDoc.bind(o,c.id), className: "am-btn am-btn-default am-btn-xs am-text-secondary"}, React.createElement("span", {className: "am-icon-search"}), "确定")
				        )
				    )
