	...
	render:function(){
		...
		return(
				React.createElement("tr", null, 
	              ...
	              React.createElement("td", null, c.money), 
		...
		return(
			React.createElement("div", {className: "admin-content"}, 
			    ...
			    React.createElement("div", {className: "am-cf am-padding"}, 
			      React.createElement("div", {className: "am-fl am-cf"}, React.createElement("strong", {className: "am-text-primary am-text-lg"}, "红包管理"), " / ", React.createElement("small", null, "列表"))
				), 
