var R_content = React.createClass({displayName: "R_content",
	getInitialState: function() { 
		...
		return {data: [],total:0,totalpage: [],isFirst:"am-disabled",isLast:"am-disabled",isAdmin:isAdmin,settings:[]};
	},
	newDoc:function(){
	...
	toPage:function(page,e){
		...
		$.ajax({
			...
			success: function(data) {
				...
				o.setState({settings:data.settings});
	...
	render:function(){
		...
		return(
				React.createElement("tr", null, 
	              ...
	              React.createElement("td", null, settings), 
