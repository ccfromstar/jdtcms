var R_content = React.createClass({displayName: "R_content",
	...
	componentDidMount:function(){
		$("#start_time").bing("click",function(){
	...
	render:function(){
		...
		return(
				React.createElement("tr", null, 
	              ...
	              React.createElement("td", null, c.score_1)
	            )
			);
		});
		var pager=[];
			    ...
			    React.createElement("div", {className: "am-g"}, 
			      React.createElement("div", {className: "am-u-sm-12 am-u-md-12"}, 
			        React.createElement("div", {className: "am-btn-toolbar"}, 
			          		...
			          		React.createElement("input", {type: "text", id: "start_time", className: "am-form-field", placeholder: "开始日期", "data-am-datepicker": true, readOnly: true, required: true}), 
			          		React.createElement("input", {type: "text", id: "end_time", className: "am-form-field", placeholder: "结束日期", "data-am-datepicker": true, readOnly: true, required: true}), 
