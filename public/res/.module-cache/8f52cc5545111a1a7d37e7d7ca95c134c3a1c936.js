var R_content = React.createClass({displayName: "R_content",
	...
	UpdateDoc:function(e){
		...
		if(isNaN(day_initial) || isNaN(score_focus) || isNaN(score_read) || isNaN(score_like) || isNaN(score_transpond) || isNaN(score_admin_focus) || isNaN(score_admin_read) || isNaN(score_admin_like) || isNaN(score_admin_transpond)){
				    ...
				    React.createElement("div", {className: "am-panel am-panel-default admin-sidebar-panel"}, 
				        React.createElement("div", {className: "am-panel-bd"}, 
						  ...
						  React.createElement("p", null, "阅读软文获得的积分", 
				       		...
				       		"建定通使用天数", 
				       		React.createElement("input", {type: "text", id: "dat_read", className: "am-input-sm settings_input"})
				       		), 	
