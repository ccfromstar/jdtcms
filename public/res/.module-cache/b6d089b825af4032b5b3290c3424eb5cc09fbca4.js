var R_content = React.createClass({displayName: "R_content",
	...
	componentDidMount:function(){
		...
		var readdocid = GetQueryString("id");
		...
		$.ajax({
			...
			success: function(data) {
				...
				$("#post_info").html("阅读 "+data[0].read_count + " <span id='thumbs' class='am-icon-thumbs-o-up'></span> "+data[0].like_count);
				//修复图片，表格太宽的问题
				...
				React.createElement("div", {className: "am-u-md-12"}, 
					React.createElement("article", {className: "post-main"}, 
						...
						React.createElement("div", {id: "post_info"}, 
							"阅读 ", React.createElement("span", {id: "read_count"}), React.createElement("span", {id: "thumbs", className: "am-icon-thumbs-o-up"}), "   ", React.createElement("span", {id: "read_count"})
						)
					)
				)
			)
