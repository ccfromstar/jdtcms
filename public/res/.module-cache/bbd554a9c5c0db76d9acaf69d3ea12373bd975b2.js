			...
			React.createElement("div", {className: "admin-sidebar am-offcanvas", id: "admin-offcanvas"}, 
			    React.createElement("div", {className: "am-offcanvas-bar admin-offcanvas-bar"}, 
			      React.createElement("ul", {className: "am-list admin-sidebar-list"}, 
			      	React.createElement("li", null, React.createElement("a", {href: "index.html"}, React.createElement("span", {className: "am-icon-table"}), "关注者行为查询")), 
			      	React.createElement("li", null, React.createElement("a", {href: "index.html"}, React.createElement("span", {className: "am-icon-table"}), "关注者查询")), 
			      	React.createElement("li", null, React.createElement("a", {href: "index.html"}, React.createElement("span", {className: "am-icon-table"}), " 关注用户")), 
			      	React.createElement("li", null, React.createElement("a", {href: "index.html"}, React.createElement("span", {className: "am-icon-table"}), " 关注用户")), 
			       	React.createElement("li", null, React.createElement("a", {href: "index.html"}, React.createElement("span", {className: "am-icon-table"}), " 关注用户")), 
