		...
		return(
			React.createElement("div", {className: "admin-content"}, 
			    ...
			    React.createElement("div", {className: "am-g"}, 
			      React.createElement("div", {className: "am-u-sm-12 am-u-md-6"}, 
			      ...
			      React.createElement("div", {class: "am-u-sm-12 am-u-md-3"}, 
			        React.createElement("div", {class: "am-form-group"}, 
			          React.createElement("select", {"data-am-selected": "{btnSize: 'sm'}"}, 
			            React.createElement("option", {value: "option1"}, "所有类别"), 
			            React.createElement("option", {value: "option2"}, "IT业界"), 
			            React.createElement("option", {value: "option3"}, "数码产品"), 
			            React.createElement("option", {value: "option3"}, "笔记本电脑"), 
			            React.createElement("option", {value: "option3"}, "平板电脑"), 
			            React.createElement("option", {value: "option3"}, "只能手机"), 
			            React.createElement("option", {value: "option3"}, "超极本")
			          )
			        )
			      ), 
