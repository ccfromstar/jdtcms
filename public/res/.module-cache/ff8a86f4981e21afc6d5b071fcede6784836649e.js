				       	...
				       	React.createElement("div", {className: "am-form"}, 
					        ...
					        React.createElement("div", {className: "am-g am-margin-top"}, 
					            ...
					            React.createElement("div", {className: "am-hide-sm-only am-u-md-6"}, 
									React.createElement("input", {type: "text", className: "am-input-sm wx_user_input"}), 
									React.createElement("button", {type: "button", onClick: this.cancleDoc, className: "btn-c am-btn am-btn-primary am-btn-xs"}, "确定")
					            )
					        ), 
