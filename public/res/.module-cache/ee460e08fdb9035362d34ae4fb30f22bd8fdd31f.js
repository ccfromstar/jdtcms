var R_content = React.createClass({displayName: "R_content",
	...
	render:function(){
		...
		var _subtime = new Date(parseInt(c.subscribe_time) * 1000).toLocaleString().replace(/年|月/g, "-").replace(/日/g, " "); 
		return(
				React.createElement("tr", null, 
				  React.createElement("td", null, React.createElement("img", {className: "wx_user_header_img", src: c.headimgurl})), 
			      ...
			      React.createElement("div", {className: "am-u-sm-12 am-u-md-9"}, 
			        React.createElement("div", {className: "am-btn-toolbar"}, 
			          React.createElement("div", {className: "am-btn-group am-btn-group-xs"}, 
			            ...
			            React.createElement("button", {type: "button", onClick: this.UpdateWxUser, className: "am-btn am-btn-default "}, React.createElement("span", {className: "am-icon-plus"}), " 更新"), 
