			...
			React.createElement("div", {className: "admin-sidebar am-offcanvas", id: "admin-offcanvas"}, 
			    React.createElement("div", {className: "am-offcanvas-bar admin-offcanvas-bar"}, 
			      React.createElement("ul", {className: "am-list admin-sidebar-list"}, 
			      	React.createElement("li", null, React.createElement("a", {href: "record.html"}, React.createElement("span", {className: "am-icon-sitemap"}), " 关注者行为查询")), 
					...
					React.createElement("li", null, React.createElement("a", {href: "jdtuser.html"}, React.createElement("span", {className: "am-icon-window"}), " 建定通账户管理")), 
					React.createElement("li", {className: "admin-parent"}, 
						...
						React.createElement("ul", {className: "am-list am-collapse admin-sidebar-sub am-in", id: "collapse-nav"}, 
            				React.createElement("li", null, React.createElement("a", {href: "post.html"}, React.createElement("span", {className: "am-icon-bookmark"}), " 软文管理"))
          				)
					), 
					React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-flag"}), " 我的信息"))
			      ), 
