			...
			React.createElement("div", {className: "admin-sidebar am-offcanvas", id: "admin-offcanvas"}, 
			    React.createElement("div", {className: "am-offcanvas-bar admin-offcanvas-bar"}, 
			      React.createElement("ul", {className: "am-list admin-sidebar-list"}, 
					...
					React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-user"}), "服务号管理")), 
					React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-user"}), "管理员帐号管理"))
			      ), 
