var R_content = React.createClass({displayName: "R_content",
	...
	UpdateDoc:function(e){
		...
		if(isNaN(score_focus) || isNaN(score_focus) || isNaN(score_read) || isNaN(score_like) || isNaN(score_transpond) || isNaN(score_admin_focus) || isNaN(score_admin_read) || isNaN(score_admin_like) || isNaN(score_admin_transpond)){
