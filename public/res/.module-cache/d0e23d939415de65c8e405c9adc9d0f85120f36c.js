			...
			React.createElement("div", {className: "admin-sidebar am-offcanvas", id: "admin-offcanvas"}, 
			    React.createElement("div", {className: "am-offcanvas-bar admin-offcanvas-bar"}, 
			      React.createElement("ul", {className: "am-list admin-sidebar-list"}, 
			      	React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-sitemap"}), " 关注者行为查询")), 
			      	React.createElement("li", null, React.createElement("a", {href: "index.html"}, React.createElement("span", {className: "am-icon-wechat"}), " 关注者查询")), 
			      	React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-table"}), " 奖罚统计")), 
			      	React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-table"}), " 员工业绩查询")), 
			       	React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-table"}), " 系统设定")), 
					React.createElement("li", null, React.createElement("a", {href: "user.html"}, React.createElement("span", {className: "am-icon-table"}), " 管理员帐号管理")), 
					React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-table"}), " 服务号管理")), 
					React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement("span", {className: "am-icon-table"}), " 我的信息"))
			      ), 
